...
# S3_URL="http://obs.myhwclouds.com"   Specify Huawei OBS as the S3 provider 
#
# Example of running against Amazon S3 using a bucket named "bucket:
#
# S3FS_CREDENTIALS_FILE=keyfile TEST_BUCKET_1=bucket S3PROXY_BINARY="" S3_URL="http://obs.myhwclouds.com" ./small-integration-test.sh
#
...
#
#    S3FS_CREDENTIALS_FILE=keyfile TEST_BUCKET_1=bucket S3PROXY_BINARY="" S3_URL="http://obs.myhwclouds.com" make check
#
