...
void show_help (void)
{
  ...
  printf(
    ...
    "      multipart copy.\n"
    "\n"
    "   url (default=\"https://obs.myhwclouds.com\")\n"
    "      - sets the url to use to access Amazon S3. If you want to use HTTP,\n"
    "        then you can set \"url=http://obs.myhwclouds.com\".\n"
    "        If you do not use https, please specify the URL with the url\n"
    "        option.\n"
    "\n"
    "   endpoint (default=\"cn-north-1\")\n"
    "      - sets the endpoint to use on signature version 4\n"
    "      If this option is not specified, s3fs uses \"cn-north-1\" region as\n"
